  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        outline: "border-2 border-primary/20 bg-background hover:border-primary/50 hover:bg-primary/5 hover:shadow-md",
        ...
        premium: "gradient-primary text-white hover:shadow-glow hover:-translate-y-1 font-semibold",
        success: "gradient-success text-white hover:shadow-lg hover:-translate-y-0.5 font-medium",
        warning: "gradient-warning text-white hover:shadow-lg hover:-translate-y-0.5 font-medium",
      },
      size: {
